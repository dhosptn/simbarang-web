        ...
        <nav class="fixed top-0 left-0 right-0 z-50 glass animate-slide-up">
            <div class="max-w-full mx-auto px-4">
                <div class="flex justify-between items-center py-4">
                    ...
                    <ul class="hidden md:flex items-center space-x-8 animate-fade-in-delay">
                        ...
                        <li><a href="<?= site_url('barang'); ?>" class="btn-gradient px-6 py-2 rounded-full text-white font-medium flex items-center space-x-2">
            ...
            <div id="mobileMenu" class="md:hidden glass border-t border-white/20 hidden">
                <div class="max-w-full mx-auto px-4 py-4 space-y-4">
                    ...
                    <a href="<?= site_url('barang/index'); ?>" class="btn-gradient px-4 py-2 rounded-lg text-white font-medium inline-flex items-center space-x-2">
                        <span>Gudang</span>
                    </a>
                </div>
            </div>
