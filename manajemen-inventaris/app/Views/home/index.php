      ...
      theme: {
        extend: {
          ...
          keyframes: {
            ...
            glow: {
              '0%': { boxShadow: '0 0 20px rgb(65, 26, 155)' },
              '100%': { boxShadow: '0 0 30px rgba(37, 39, 160, 0.8)' }
            },
            wiggle: {
...
<nav class="fixed top-0 left-0 right-0 z-50 glass animate-slide-up">
  <div class="max-w-full mx-auto px-4">
    <div class="flex justify-between items-center py-4">
      <div class="flex items-center space-x-3 animate-fade-in">
        <div class="w-10 h-10 bg-gradient-to-br from-purple-500 to-purple-700 rounded-xl flex items-center justify-center animate-float">
      ...
      <ul class="hidden md:flex items-center space-x-8 animate-fade-in-delay">
        ...
        <li><a href="barang/index" class="btn-gradient px-6 py-2 rounded-full text-white font-medium flex items-center space-x-2">
  ...
  <div id="mobileMenu" class="md:hidden glass border-t border-white/20 hidden">
    <div class="max-w-full mx-auto px-4 py-4 space-y-4">
      ...
      <a href="Views/barang/index.php" class="btn-gradient px-4 py-2 rounded-lg text-white font-medium inline-flex items-center space-x-2">
        <span>Dashboard</span>
      </a>
    </div>
  </div>
      ...
      <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 items-center w-full">
        ...
        <div class="animate-slide-left">
          ...
          <p class="text-xl text-white mb-6 max-w-md">
            Simbarang menyediakan sistem manajemen gudang yang terintegrasi untuk memudahkan bisnis Anda mengelola inventaris dengan lebih baik.
          </p>
          <span class="inline-block px-5 py-3 bg-yellow-400 text-black font-bold rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            100% Aman & Efisien
          </span>
        </div>
        <!-- Kanan: Gudang & Ikon -->
        <div class="relative flex justify-center items-center w-full h-full animate-slide-right">
          ...
          <div class="float-down w-[420px] md:w-[550px]">
            ...
            <svg viewBox="0 0 300 220" class="w-full h-auto drop-shadow-lg" xmlns="http://www.w3.org/2000/svg">
              ...
              <text x="123" y="97" font-size="9" font-weight="bold" fill="white" font-family="sans-serif">SIMBARANG</text>
              <!-- Jendela kiri -->
              ...
              <circle cx="148" cy="175" r="3" fill="#7c3aed"/>
                      ...
                      <!-- Floating Icons -->
              <div class="absolute top-[17%] right-[16%]" style="animation: float 4s ease-in-out infinite; animation-delay: 2s;">
          <div class="bg-white/20 backdrop-blur-sm shadow-xl p-4 rounded-full text-yellow-300 text-2xl border-2 border-white/30">
            📋
          </div>
        </div>

        <div class="absolute bottom-[3%] left-[11%] animate-float-slow">
          <div class="bg-white/20 backdrop-blur-sm shadow-xl p-4 rounded-full text-blue-300 text-2xl border-2 border-white/30">
            📊
          </div>
        </div>

        <div class="absolute top-[30%] left-[-5%] animate-float">
          <div class="bg-white/20 backdrop-blur-sm shadow-xl p-3 rounded-full text-green-300 text-xl border-2 border-white/30">
            📦
          </div>
        </div>
      </div>
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="glass rounded-3xl p-8 card-hover animate-slide-left">
          <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center mb-6 animate-float">
            <i class="fas fa-chart-bar text-white text-2xl"></i>
          </div>
          <h3 class="text-2xl font-bold mb-4 text-blue-300">Dashboard Real-time</h3>
        ...
        <div class="glass rounded-3xl p-8 card-hover animate-slide-up">
          <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mb-6 animate-float" style="animation-delay: 0.5s;">
        ...
        <div class="glass rounded-3xl p-8 card-hover animate-slide-right">
          <div class="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mb-6 animate-float" style="animation-delay: 1s;">
        ...
        <!-- Feature 4 -->
        <div class="glass rounded-3xl p-8 card-hover animate-slide-left">
          <div class="w-16 h-16 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center mb-6 animate-float" style="animation-delay: 1.5s;">
        ...
        <!-- Feature 5 -->
        <div class="glass rounded-3xl p-8 card-hover animate-slide-up">
          <div class="w-16 h-16 bg-gradient-to-br from-teal-500 to-blue-500 rounded-2xl flex items-center justify-center mb-6 animate-float" style="animation-delay: 2s;">
        ...
        <!-- Feature 6 -->
        <div class="glass rounded-3xl p-8 card-hover animate-slide-right">
          <div class="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center mb-6 animate-float" style="animation-delay: 2.5s;">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="animate-slide-right">
          <div class="glass rounded-3xl p-8 relative">
            <div class="absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center animate-spin-slow">
...
<div class="legend mt-2 mb-24 z-60 relative flex flex-wrap gap-20 justify-center text-white text-sm">
            ...
            <form class="space-y-6" onsubmit="handleSubmit(event)">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" class="w-full p-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300" placeholder="Masukkan nama Anda" required />
                </div>
                <div>
                  <label class="block text-sm font-medium mb-2 text-gray-300">Email</label>
                  <input type="email" class="w-full p-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300" placeholder="nama@email.com" required />
                </div>
              </div>
              
              <div>
                <label class="block text-sm font-medium mb-2 text-gray-300">Subjek</label>
                <input type="text" class="w-full p-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300" placeholder="Subjek pesan" required />
              </div>
              
              <div>
                <label class="block text-sm font-medium mb-2 text-gray-300">Pesan</label>
                <textarea rows="5" class="w-full p-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300 resize-none" placeholder="Tulis pesan Anda di sini..." required></textarea>
              </div>
              
              <button type="submit" class="w-full btn-gradient py-4 rounded-xl text-white font-semibold text-lg flex items-center justify-center space-x-3 group">
  ...
  <!-- Footer -->
<footer class="bg-gray-900 text-gray-300 py-16 relative z-0">
  <div class="max-w-screen-xl mx-auto px-6">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
      ...
      <div class="animate-slide-up delay-200">
        ...
        <ul class="space-y-3">
          <li><a href="#" class="hover:text-purple-400">Dashboard</a></li>
  ...
  <!-- Back to Top Button -->
  <button id="backToTop" class="fixed bottom-8 right-8 w-12 h-12 bg-purple-600 hover:bg-purple-700 rounded-full flex items-center justify-center text-white shadow-lg transition-all duration-300 opacity-0 pointer-events-none">
  ...
  <script>
    ...
    window.addEventListener('scroll', () => {
      ...
      const parallaxElements = document.querySelectorAll('.absolute.top-20, .absolute.top-40, .absolute.bottom-40, .absolute.top-60');
